...
const CurrencyIocnINR = ({
  ...
  return (
    ...
    >
      <path
        fill={fill}
        d="M13.66 7c-.56-1.18-1.76-2-3.16-2H6V3h12v2h-3.26c.48.58.84 1.26 1.05 2H18v2h-2c-.27 2.8-2.63 5-5.5 5h-.73l6.73 7h-2.77L7 14v-2h3.5c1.76 0 3.22-1.3 3.46-3H6V7z"
      ></path>
    </svg>
  );
};
  ...
  return (
    ...
    >
      <g fill={fill} fillRule="evenodd" clipRule="evenodd">
        <path d="M6.5 11a1 1 0 0 0-1 1v5.5a1 1 0 0 0 1 1H9a1 1 0 0 0 1-1V12a1 1 0 0 0-1-1zm1.25 6a1 1 0 1 0 0-2a1 1 0 0 0 0 2m6.731-9.335a.167.167 0 0 0-.273.056l-.194 1.165A5.161 5.161 0 0 1 12.23 12v4.681l4.196.84a.754.754 0 0 1 .082.02a1.432 1.432 0 0 0 1.603-.63l.217-.353l.507-1.338a3.899 3.899 0 0 0-.018-2.809l-.31-.621a1.427 1.427 0 0 0-1.272-.79H15.73c-.043 0-.084-.003-.125-.008a1 1 0 0 1-1.096-1.235l.15-.594a1.98 1.98 0 0 0 .057-.547l-.014-.41a.849.849 0 0 0-.202-.521zm-3.428 10.82l4.947.989a3.432 3.432 0 0 0 3.815-1.516l.257-.416a1.003 1.003 0 0 0 .1-.206l.534-1.409a5.899 5.899 0 0 0-.044-4.292a.998.998 0 0 0-.037-.082l-.329-.659A3.427 3.427 0 0 0 17.231 9h-.525a4.02 4.02 0 0 0 .01-.453l-.014-.41a2.849 2.849 0 0 0-.764-1.844l-.043-.042c-1.19-1.192-3.226-.628-3.634 1.006a1.01 1.01 0 0 0-.017.079l-.203 1.221a3.161 3.161 0 0 1-1.354 2.104a1 1 0 0 0-.456.839v5.98a1.002 1.002 0 0 0 .822 1.004"></path>
...
const ShareIcon = ({ size = 24, color = "none", fill = "currentColor" }) => {
  return (
    ...
    >
      <path
        fill={fill}
        d="M15.991 1.035a4 4 0 1 1-.855 6.267l-6.28 3.626a4.007 4.007 0 0 1 0 2.144l6.28 3.626a4.002 4.002 0 0 1 6.32 4.803a4 4 0 0 1-7.32-3.07l-6.28-3.627a4.002 4.002 0 1 1 0-5.608l6.28-3.626a4.002 4.002 0 0 1 1.855-4.535M19.723 3.5a2 2 0 1 0-3.464 2a2 2 0 0 0 3.464-2M3.071 12.527a2.002 2.002 0 0 0 2.93 1.204a2 2 0 1 0-2.93-1.204m15.92 5.242a2 2 0 1 0-2 3.464a2 2 0 0 0 2-3.464"
      ></path>
    </svg>
  );
};
